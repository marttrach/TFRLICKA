...
!curl -LO https://github.com/SeanChangX/THSR-Sniper/raw/refs/heads/main/thsr_ocr/datasets/20250825_balanced.tar.gz
!tar -xf 20250825_balanced.tar.gz

"""The dataset contains 1996 captcha files as `jpg` images. The label for each sample is a string,
